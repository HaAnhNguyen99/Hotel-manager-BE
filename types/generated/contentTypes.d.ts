...
export interface ApiRoomRoom extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    first_hourly_price: Schema.Attribute.BigInteger;
    ...
    room_status: Schema.Attribute.Enumeration<
...
export interface ApiServiceUsageServiceUsage
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    UsageDate: Schema.Attribute.DateTime;
  };
}
